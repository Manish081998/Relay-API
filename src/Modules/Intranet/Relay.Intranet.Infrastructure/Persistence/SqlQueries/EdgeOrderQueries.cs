...
internal static class EdgeOrderQueries
{
    ...
    public const string TrackOrderChanges = "dbo.TrackOrderChanges_Updated";
    ...
    public const string CheckForValidOrder = "select count(1) from EdgeOrders where repPO = @po";
}
