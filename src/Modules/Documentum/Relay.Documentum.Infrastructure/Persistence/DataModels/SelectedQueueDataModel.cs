...
internal sealed class SelectedQueueDataModel
{
    ...
    public static SelectedQueueDataModel FromRecord(IDataRecord record) => new()
    {
    ...
    public SelectedQueueDto ToDto() => new(BrandId, BrandName, QueueId, QueueName);
}
